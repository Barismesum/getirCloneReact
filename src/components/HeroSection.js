      ...
      <div className="md:container flex justify-between items-center relative md:absolute top-0 left-0 md:left-1/2 translate-x-0 md:-translate-x-1/2 h-full z-20">
        ...
        <div className="w-full md:w-[400px] md:rounded-lg bg-gray-50 p-6">
          ...
          <div className="grid gap-y-3">
            ...
            <button className="bg-blue-700 bg-opacity-10 px-4  text-blue-700 text-opacity-80 transition-colors hover:bg-blue-700 hover:text-white h-12 flex items-center  w-full rounded-md text-sm font-semibold">
              <FaFacebook size={24} />
